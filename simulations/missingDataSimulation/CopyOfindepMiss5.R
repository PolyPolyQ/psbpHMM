# 5% missing simulation script for INDEP 
# rm(list=ls())
# gc()
...
rownames(missingResults) <- c("full5", "nox5")
colnames(missingResults) <- NULL

#cat results/ind5miss*.csv > combined_results/miss5IndResults.txt

list.save(dat1, file = paste0("/projects/lvheck@colostate.edu/markovPSBP/simulations/results/indmiss5data", simnum, ".rds"))
write.table(missingResults, file = paste0("/projects/lvheck@colostate.edu/markovPSBP/simulations/results/ind5miss", simnum, ".csv"), 
