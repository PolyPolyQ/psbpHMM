...
rownames(missingResults) <- c("full5", "nox5", "dpmm5")
colnames(missingResults) <- NULL

#cat results/miss5percent*.csv > combined_results/miss5percentResults.txt

list.save(dat1, file = paste0("/projects/lvheck@colostate.edu/markovPSBP/simulations/results/miss5data", simnum, ".rds"))
write.table(missingResults, file = paste0("/projects/lvheck@colostate.edu/markovPSBP/simulations/results/miss5percent", simnum, ".csv"), 
