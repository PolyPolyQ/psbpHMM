...
To summarize the results from the independently fit models, use the function `getIndepSimResults`. Here, you must also include the emission data as a parameter. 
